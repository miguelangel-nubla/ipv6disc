...
- `-plugin`: Plugin configuration: `type:params` (can be specified multiple times, multiple instances of the same plugin connected to different hosts are allowed)
